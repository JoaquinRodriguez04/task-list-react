...
const TaskList = ({currentTasks, deleteTask}) => {
  return (
    // si el estado de las tareas no esta vacio se le agrega una clase al ul para que su display sea en grilla y el h2 que se renderiza si no hay tareas pueda abracar todo su ancho
